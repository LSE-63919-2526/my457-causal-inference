...
Let's make treatment assignment a function of just three of our covariates, $X$, $Q$, $W$, plus some random noise from $U2$. To do this, we will use $X$, $Q$, $W$, and $U2$ to generate a propensity score, which is the probability of receiving treatment. We can then generate our realized outcomes $Y$.
...
m.out.nn = matchit(D ~ X + Q, data = data, method = "nearest", distance = "mahalanobis")
